...
if (document.readyState === 'loading') {
  ...
  // Chrome cookie
browser.storage.local.get(["enableNickName"], (StatusNickName) => {
 browser.storage.local.get(["enableRank"], (StatusRank) => {
  browser.storage.local.get(["banner1IMG"], (getBanner1IMG) => {
 browser.storage.local.get(["banner2IMG"], (getBanner2IMG) => {
      ...
      browser.storage.local.get(["Rank"], (getRank) => {
       browser.storage.local.get(["Active"], (getActive) => {
        browser.storage.local.get(["Rules"], (getRules) => {
         browser.storage.local.get(["paitingText"], (getPaitingText) => {
          browser.storage.local.get(["paitingTextToggle"], (getPaitingTextToggle) => {
           browser.storage.local.get(["LikeEnableButton"], (getLikeEnableButton) => {
                ...
                let buttons;
                let first_banner = getBanner1IMG.banner1IMG ;
                let second_banner = getBanner2IMG.banner2IMG;
                     ...
                     if (permission == "tech") {
                      ...
                      buttons = [
                        ...
                        },
                        {
                          title: 'Передать',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            ...
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          title: 'Одобрено',
                          content:
...
<br>09. Связь с Вами по Telegram/VK: [/CODE] [/CENTER]<br>` +
                    ...
                    if (permission == "admin") {
                      buttons = [
                        ...
                        {
                          title: 'Жалоба одобрена (ОДОБРЕНО)',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            '[Color=Flame][CENTER]Одобрено.[/I][/CENTER][/color]<br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>`,
                        },
                        {
                        ...
                        {
                          title: 'Жалоба отказано (ОТКАЗ)',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            '[Color=Flame][CENTER]Отказано.[/I][/CENTER][/color]<br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>`,
                        },
                        {
                        ...
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.19[/color]. Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины | [Color=Red]Jail 90 минут[/color].[/CENTER]<br>" +
                             `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER][FONT=georgia][B][I]Нарушитель будет наказан по пункту правил: [Color=Red]2.22[/color]. Запрещено хранить / использовать / распространять стороннее программное обеспечение или иные средства, позволяющие получить преимущество над другими игроками, включая макросы (в том числе с эмуляторов) | [Color=Red] Ban 15 - 30 дней / PermBan[/color] <br>" +                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
...

                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.33[/color]. Запрещено пользоваться уязвимостью правил | [Color=Red]Ban 15 дней[/CENTER]<br>" +                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        {
                          title: 'Помеха Медийным личностям',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
...

                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.24[/color].  Запрещено скрывать от администрации нарушителей или злоумышленников | [Color=Red]Ban 15 - 30 дней / PermBan + ЧС проекта[/CENTER]<br>" +                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` + 
                            '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        {
                          title: 'Скрытие уязвимостей',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.23[/color]. Запрещено скрывать от администрации ошибки игровых систем, а также распространять их игрокам | [Color=Red]Ban 15 - 30 дней / PermBan[/CENTER]<br>" +                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.25[/color]. Запрещены попытки или действия, которые могут навредить репутации проекта | [Color=Red]PermBan + ЧС проекта[/CENTER]<br>" +                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        {
                          title: 'Обжалование ЧСС/ЧСА/ОЧСА/ЧСМ/ЧСП',
                          dpstyle: 'oswald: 3px;     color: #fff; background: #FF4500; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FF4500',
                        },
                        {
                          title: 'В обжаловании отказ',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел ваше обжалование, и готов вынести вердикт:[/CENTER]<br>` +                              
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             "[CENTER]В обжаловании отказано.[/CENTER]<br>" +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел ваше обжалование, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Вы были вынесены из черного списка сервера.[/CENTER]<br>" +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел ваше обжалование, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Вы были вынесены из черного списка Администраторов.[/CENTER]<br>" +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел ваше обжалование, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Вы были вынесены из общего черного списка Администраторов.[/CENTER]<br>" +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел ваше обжалование, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Вы были вынесены из общего черного списка проекта.[/CENTER]<br>" +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                        ...
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил:[Color=Red]3.04[/color]. Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) | [Color=Red]Mute 300 минут / Ban 7 дней[/color].[/CENTER]<br>" +                            
                             `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.54[/color]. Запрещено неуважительное обращение, оскорбление, неадекватное поведение, угрозы в любом проявлении по отношению к администрации. | [Color=Red]Mute 180 / 300 минут (при повторном нарушении)[/CENTER]<br>" +                            
                             `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                             '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        {
                          ...
                          content:
                            ...
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            `[CENTER]Я ${rang} ${nickname} рассмотрел вашу жалобу, и готов вынести вердикт:[/CENTER]<br>` +
                            "[CENTER]Нарушитель будет наказан по данному пункту правил: [Color=Red]2.54[/color]. Запрещено неуважительное обращение, оскорбление, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации | [Color=Red]Mute 180 / 300 минут (при повторном нарушении)[/color][/CENTER]<br>" +
                              `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color]<br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        ...
                        {
                          title: 'Есть бизнес на Основа и Твинк',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                        ...
                        {
                          title: 'Плагиат Промокода Блогера',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                        ...
                        {
                          title: 'Одобрено на Агента Поддержки (АП)',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                        ...
                        {
                          title: 'Отказано на Агента Поддержки (АП)',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                        ...
                        },
                        {
                          ...
                          content:
                            ...
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
                            "[CENTER]Вы ошиблись разделом! Перенаправляю вашу жалобу.[/CENTER]<br>" +
                            '[Color=Flame][CENTER]Ожидайте ответа.[/I][/CENTER][/color]<br>' +
                            "[CENTER] Приятной игры на [Color=Red]Black Russia[/CENTER][/color]<br>" +
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]`,
                        },
                        ...
                        {
                          title: 'Использование Т/С во время БВ',
                          content:
                            `[CENTER][img width='550px']${first_banner}[/img][/CENTER]<br>` +
                            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
                            `[CENTER][img width='400px']${second_banner}[/img][/CENTER]<br>` +
        ...
        `;
                      ...
                      function updateVisibleButtons() {
                        ...
                        buttons.forEach((btn, originalIndex) => {
                          if (!searchTerm || btn.title.toLowerCase().includes(searchTerm)) {
                            const button = createButtonWithIndex(btn, originalIndex);
